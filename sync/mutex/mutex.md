...
9、判断一下当前`goroutine`是新来的还是刚被唤醒的，新来的加入到等待队列的尾部，刚被唤醒的加入到等待队列的头部，然后通过信号量阻塞，直到当前`goroutine`被放到队列的头部；  
...
<img src="/img/sync_mutex_lock.png" width = "642" height = "886" alt="mutex" align=center />
...
<img src="/img/sync_mutex_unlock.png" width = "419" height = "456" alt="mutex" align=center />
