...
- [什么是跨域](#%E4%BB%80%E4%B9%88%E6%98%AF%E8%B7%A8%E5%9F%9F)
  ...
  - [处理 AJAX 非同源的限制](#%E5%A4%84%E7%90%86-ajax-%E9%9D%9E%E5%90%8C%E6%BA%90%E7%9A%84%E9%99%90%E5%88%B6)
    ...
    - [非简单请求（not-so-simple request）](#%E9%9D%9E%E7%AE%80%E5%8D%95%E8%AF%B7%E6%B1%82not-so-simple-request)
      - [预检信息的返回](#%E9%A2%84%E6%A3%80%E4%BF%A1%E6%81%AF%E7%9A%84%E8%BF%94%E5%9B%9E)
      - [正常信息的返回](#%E6%AD%A3%E5%B8%B8%E4%BF%A1%E6%81%AF%E7%9A%84%E8%BF%94%E5%9B%9E)
...
上面的HTTP 回应中，关键的是 `Access-Control-Allow-Origin` 字段，表示 `https://www.taobao.com` 可以请求数据。该字段也可以设为 `*` 号，表示同意任意跨源请求。  
...
如果服务器否定了"预检"请求，会返回一个正常的 HTTP 回应，但是没有关键信息 `Access-Control-Allow-Origin` 的头信息字段。这时，浏览器就会认定，服务器不同意预检请求，因此触发一个错误，被 XMLHttpRequest 对象的 onerror 回调函数捕获。控制台会打印出如下的报错信息。  

<img src="/img/ip/cors_5.jpg"  alt="tcp" align="tcp" />  
...
:method: GET
:path: /h5/mtop.user.getusersimple/1.0
